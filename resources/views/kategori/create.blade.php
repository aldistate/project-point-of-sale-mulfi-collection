...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="card-body box-profile">
        {{ Form::open(['route' => 'kategori.store', 'method' => 'post', 'id' => 'form']) }}
        <div class="form-group">
          {{ Form::label('nama_kategori', 'Nama', ['class' => 'form-label']) }}
          {{ Form::text('nama_kategori', null, ['placeholder' => 'masukan nama kategori', 'class' => $errors->has('nama_kategori') ? 'form-control b-left is-invalid' : 'form-control b-left', 'id' => 'nama_kategori']) }}
          @error('nama_kategori')
