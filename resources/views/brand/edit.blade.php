  ...
  <div class="col-md-12">
    <div class=" card shadow mb-4">
      ...
      <div class="card-body box-profile">
        {{ Form::open(['route' => ['brand.update', $brand->id], 'method' => 'put', 'id' => 'form']) }}
        <div class="form-group">
          {{ Form::label('nama_brand', 'Nama', ['class' => 'form-label']) }}
          {{ Form::text('nama_brand', $brand->nama_brand, ['placeholder' => 'masukan nama guru', 'class' => $errors->has('nama_brand') ? 'form-control b-left is-invalid' : 'form-control b-left', 'id' => 'nama_brand']) }}
          @error('nama_brand')
